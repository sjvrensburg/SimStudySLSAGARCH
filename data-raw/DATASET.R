...
scenario_01 <- foreach::foreach(n_i = n, .combine = "rbind") %do% {
  ...
  matY <- dgp(spec = sls_sech_spec, param = par0,
              n = n_i, R = R, seed = seed, nthreads = 14L)
  cbind(
    n = n_i,
    lambda = parameters$lambda[scenario],
    rhow = parameters$lambda[scenario],
    as.data.frame(matY))
}
scenario_01 |>
  write_fst(path = "inst/extdata/scenario_01.fst",
            compress = 25)
rm(scenario_01)
...
scenario_02 |>
  write_fst(path = "inst/extdata/scenario_02.fst",
            compress = 25)
rm(scenario_02)
...
scenario_03 |>
  write_fst(path = "inst/extdata/scenario_03.fst",
            compress = 25)
rm(scenario_03)
...
scenario_04 |>
  write_fst(path = "inst/extdata/scenario_04.fst",
            compress = 25)
rm(scenario_04)
...
scenario_05 |>
  write_fst(path = "inst/extdata/scenario_05.fst",
            compress = 25)
rm(scenario_05)
...
scenario_06 |>
  write_fst(path = "inst/extdata/scenario_06.fst",
            compress = 25)
rm(scenario_06)
...
scenario_07 |>
  write_fst(path = "inst/extdata/scenario_07.fst",
            compress = 25)
rm(scenario_07)
...
scenario_08 |>
  write_fst(path = "inst/extdata/scenario_08.fst",
            compress = 25)
rm(scenario_08)
...
scenario_09 |>
  write_fst(path = "inst/extdata/scenario_09.fst",
            compress = 25)
rm(scenario_09)
